...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"edit.js":[function(require,module,exports) {
"use strict";
...
axios_1["default"].get(api + "/characters").then(function (response) {
  // handle success
  var result = response.data; // console.log(response);
  ...
  result.forEach(function (element) {
    ...
    var contentName = document.createTextNode(template);
    div.appendChild(contentName);
    var currentDiv = document.getElementById("div"); // ???

    document.body.insertBefore(div, currentDiv); // Indicate where insert the new container inthe DOM
  });
...
},{}]},{},["../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","edit.js"], null)
