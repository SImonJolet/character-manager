...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"home.js":[function(require,module,exports) {
"use strict";
...
axios_1["default"].get(api + "/characters").then(function (response) {
  ...
  var displayHero = function displayHero(el) {
  ...
  bts.forEach(function (el) {
    el.addEventListener("click", function () {
      var id = el.value;
      console.log(id);
      if (confirm("Are you sure ?? I mean, for real ?")) axios_1["default"]["delete"](api + "/characters/" + id).then(function (response) {
...
},{}]},{},["../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","home.js"], null)
